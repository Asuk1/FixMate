  ...
  return new Promise((resolve) => {
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        ...
        // Limiter la taille maximale à 1920px (Full HD)
        const maxSize = 1920;
        ...
        // Convertir en blob avec qualité 0.8 (80%)
        canvas.toBlob(
          (blob) => {
  ...
  <div v-if="props.role === 'cleaner'" class="upload-zone">
    ...
    <div class="drop-zone"
      ...
      <div class="drop-zone-content">
        ...
        <p class="upload-hint">Accepted formats: JPG, PNG, GIF • Max 100MB per photo</p>
      </div>
    </div>
